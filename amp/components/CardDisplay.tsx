...
import { card, card2, card3, CloverCard } from '../app/data/card'; // Import card instances
...
const CardComponent = ({ id, image, isMain = false, onClick, isSelected = false }: CardProps) => (
  <motion.div
    ...
    whileHover={{ scale: isMain ? 1.5 : 1.1 }} // Scale CloverCard to 1.5, secondary cards to 1.1 on hover
...
const CardDisplay: React.FC = () => {
  ...
  const mainCard = { id: 0, isMain: true, image: CloverCard.getFrontImage() };
  const additionalCards = [card, card2, card3];
